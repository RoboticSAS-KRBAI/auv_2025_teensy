...
//   1521,  // T1  (idx 0) — belum diukur, pakai nilai tertinggi (aman)
//   1518,  // T2  (idx 1) — diukur
//   1519,  // T3  (idx 2) — diukur
//   1519,  // T4  (idx 3) — diukur
//   1519,  // T5  (idx 4) — diukur
//   1519,  // T6  (idx 5) — diukur
//   1521,  // T7  (idx 6) — diukur
//   1519,  // T8  (idx 7) — diukur
//   1521,  // T9  (idx 8) — belum diukur, pakai nilai tertinggi (aman)
//   1521   // T10 (idx 9) — belum diukur, pakai nilai tertinggi (aman)
// };

// const int THRUSTER_REVERSE_START[10] = {
//   1467,  // T1  (idx 0) — belum diukur, pakai nilai terendah (aman)
//   1476,  // T2  (idx 1) — diukur
//   1477,  // T3  (idx 2) — diukur
//   1477,  // T4  (idx 3) — diukur
//   1467,  // T5  (idx 4) — diukur 1476, TAPI tidak stabil! Pakai 1467 agar nyala terus
//   1477,  // T6  (idx 5) — diukur
//   1479,  // T7  (idx 6) — diukur
//   1476,  // T8  (idx 7) — diukur
//   1467,  // T9  (idx 8) — belum diukur, pakai nilai terendah (aman)
//   1467   // T10 (idx 9) — belum diukur, pakai nilai terendah (aman)
// };
