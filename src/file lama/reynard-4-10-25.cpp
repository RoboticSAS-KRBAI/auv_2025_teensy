...
//   float yaw = 0.0, yaw_360 = 0.0, last_yaw = 0.0, last_yaw_360 = 0.0, delta_yaw = 0.0;
...
//       delta_yaw = abs(last_yaw - yaw_360);
...
//     Serial.println("----------------------");
//     Serial.print("sensor yaw = "); Serial.println(yaw_360);
