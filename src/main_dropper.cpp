...
// # define DROP_BALL_PIN 17
// bool drop_ball_state = false;
...
// // Declare Publishers
// rcl_publisher_t pub_pwm, pub_error, pub_sensor, pub_set_point, pub_pid, pub_status, pub_boost, pub_velocity_sensor, pub_drop_ball;

// // Declare Subscribers
// rcl_subscription_t sub_status, sub_boost, sub_pid, sub_set_point, sub_object_difference, sub_drop_ball;
...
// std_msgs__msg__Bool drop_ball_msg;
...
//   pinMode(DROP_BALL_PIN, OUTPUT);
//   digitalWrite(DROP_BALL_PIN, LOW);
...
//   std_msgs__msg__Bool__init(&drop_ball_msg);

//   status_msg.data.data = malloc(50);
//   status_msg.data.capacity = 50;
//   status_msg.data.size = 0;

//   drop_ball_msg.data.data = malloc(sizeof(bool));
//   drop_ball_msg.data.capacity = sizeof(bool);
//   drop_ball_msg.data.size = sizeof(bool);
...
// void run_control_loop()
// {
//     digitalWrite(DROP_BALL_PIN, drop_ball_state ? HIGH : LOW);
//     drop_ball_msg.data = drop_ball_state;
